...
import PlaceholderFacet from './PlaceholderFacet.vue';
...
export default {
    ...
    mounted() {
        ...
        this.facetSettingsConfig = this.config.facetConfig;
    },
    data() {
        return {
    ...
    computed: {
        ...
        ...mapGetters([
            'config',
            'facetsCollapseAllTrigger'
        ])
    },
    watch: {
        facetsCollapseAllTrigger: function(newVal) {
            if (newVal) {
                this.collapseAll();
            }
        }
